...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.UpdateMenu=function()
		{
			...
			else if (Game.onMenu=='stats')
			{
				...
				'<div class="listing"><b>Dabloons per second :</b> '+Beautify(Game.cookiesPs,1)+' <small>'+
	...
	Game.Draw=function()
	{
		...
		if (!Game.OnAscend)
		{
			...
			var unit=(Math.round(Game.cookiesd)==1?' dabloon':' dabloons');
			...
			if (str.length>11 && !Game.mobile) unit='<br>dabloons';
			str+=unit;
